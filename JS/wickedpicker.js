    ...
    $.extend(Wickedpicker.prototype, {
        ...
        createPicker: function () {
            if ($('.wickedpicker').length === 0) {
                var picker =    '<div class="wickedpicker"><p class="wickedpicker__title">' + this.options.title + '<span class="wickedpicker__close"></span></p>' + 
                                    '<ul class="wickedpicker__controls">' +
                                        '<li class="wickedpicker__controls__control"><span class="' + this.options.upArrow + '">' + 
                                            '</span><span class="wickedpicker__controls__control--hours" tabindex="-1">00</span><span class="' + this.options.downArrow + '"></span>' +
                                        '</li>' +
                                        ...
                                        '<li class="wickedpicker__controls__control">' +
                                            '<span class="' + this.options.upArrow + '"></span><span class="wickedpicker__controls__control--minutes" tabindex="-1">00</span><span class="' + this.options.downArrow + '"></span>' +
                                        '</li>';
                                        if (this.options.showSeconds) {
                                            picker += '<li class="wickedpicker__controls__control--separator">' + 
                                                            '<span class="wickedpicker__controls__control--separator-inner">:</span>' + 
                                                        '</li>' + 
                                                        '<li class="wickedpicker__controls__control">' + 
                                                            '<span class="' + this.options.upArrow + '"></span><span class="wickedpicker__controls__control--seconds" tabindex="-1">00</span><span class="' + this.options.downArrow + '"></span>' +
                                                        '</li>';
                                        }
                                        picker += '<li class="wickedpicker__controls__control">' +
                                                        '<span class="' + this.options.upArrow + '"></span><span class="wickedpicker__controls__control--meridiem" tabindex="-1">AM</span><span class="' + this.options.downArrow + '"></span>' +
                                                    '</li>' +
                                    '</ul>' +
                                '</div>';
                    $('body').append(picker);
